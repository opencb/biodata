...
public class VariantClassificationTest {
    ...
    public void clinicalSignificanceTest() {
        ...
        assertEquals(clinicalSignificance, VariantClassification.ClinicalSignificance.PATHOGENIC);
        ...
        clinicalSignificance = VariantClassification.computeClinicalSignificance(acmgs);
        System.out.println(StringUtils.join(acmgs, ",") + " -> " + clinicalSignificance);
        assertEquals(clinicalSignificance, VariantClassification.ClinicalSignificance.LIKELY_PATHOGENIC);
        ...
        clinicalSignificance = VariantClassification.computeClinicalSignificance(acmgs);
        System.out.println(StringUtils.join(acmgs, ",") + " -> " + clinicalSignificance);
        assertEquals(clinicalSignificance, VariantClassification.ClinicalSignificance.BENIGN);
        ...
        clinicalSignificance = VariantClassification.computeClinicalSignificance(acmgs);
        System.out.println(StringUtils.join(acmgs, ",") + " -> " + clinicalSignificance);
        assertEquals(clinicalSignificance, VariantClassification.ClinicalSignificance.LIKELY_BENIGN);
