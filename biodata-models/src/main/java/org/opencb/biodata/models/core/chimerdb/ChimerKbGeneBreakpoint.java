...
public class ChimerKbGeneBreakpoint {
    ...
    public ChimerKbGeneBreakpoint setChromosome(String chromosome) {
        this.chromosome = chromosome;
        return this;
    }
    ...
    public ChimerKbGeneBreakpoint setPosition(int position) {
        this.position = position;
        return this;
    }
    ...
    public ChimerKbGeneBreakpoint setStrand(String strand) {
        this.strand = strand;
        return this;
    }
}
