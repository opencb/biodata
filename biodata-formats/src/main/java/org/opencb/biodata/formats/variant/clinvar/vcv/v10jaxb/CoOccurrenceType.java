 ...
 *       &lt;sequence>
 *         &lt;element name="Zygosity" type="{}typeZygosity" minOccurs="0"/>
 *         &lt;element name="AlleleDescSet" type="{}typeAlleleDescr" maxOccurs="unbounded" minOccurs="0"/>
...
public class CoOccurrenceType {
    ...
    protected TypeZygosity zygosity;
    @XmlElement(name = "AlleleDescSet")
    protected List<TypeAlleleDescr> alleleDescSet;
     ...
     *     
     */
    public TypeZygosity getZygosity() {
        return zygosity;
    }
     ...
     *     
     */
    public void setZygosity(TypeZygosity value) {
        this.zygosity = value;
    }
     ...
     * {@link TypeAlleleDescr }
     * 
     * 
     */
    public List<TypeAlleleDescr> getAlleleDescSet() {
        if (alleleDescSet == null) {
            alleleDescSet = new ArrayList<TypeAlleleDescr>();
        }
