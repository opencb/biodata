...
/**
 * inside ClinicalAssertion, A structure to support reporting of an accession, its version, the date its status changed, and
 *          text describing that change.
 * 
 * <p>Java class for typeClinicalAssertionRecordHistory complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="typeClinicalAssertionRecordHistory">
 *   &lt;complexContent>
...
@XmlType(name = "typeClinicalAssertionRecordHistory", propOrder = {
    "comment"
})
public class TypeClinicalAssertionRecordHistory {
