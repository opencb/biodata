...
/**
 * <p>Java class for typeCitation complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="typeCitation">
 *   &lt;complexContent>
...
@XmlType(name = "typeCitation", propOrder = {
    "id",
    "url",
    "citationText"
})
public class TypeCitation {
    ...
    @XmlElement(name = "ID")
    protected List<TypeCitation.ID> id;
    @XmlElement(name = "URL")
     ...
     * {@link TypeCitation.ID }
     * 
     * 
     */
    public List<TypeCitation.ID> getID() {
        if (id == null) {
            id = new ArrayList<TypeCitation.ID>();
        }
        return this.id;
    }
