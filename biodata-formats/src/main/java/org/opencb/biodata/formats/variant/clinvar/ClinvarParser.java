...
public class ClinvarParser {
    ...
    public final static String CLINVAR_CONTEXT_v59 = "org.opencb.biodata.formats.variant.clinvar.v59jaxb";

    public static void saveXMLInfo(Object obj, String filename) throws FileNotFoundException, JAXBException {
        JAXBContext jaxbContext;
        jaxbContext = JAXBContext.newInstance(CLINVAR_CONTEXT_v59);
    ...
    public static Object loadXMLInfo(String filename) throws JAXBException {
        Object obj = null;
        JAXBContext jaxbContext = JAXBContext.newInstance(CLINVAR_CONTEXT_v59);
