...
/**
 * <p>Java class for typeCommentType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeCommentType">
 ...
 * 
 */
@XmlType(name = "typeCommentType")
@XmlEnum
public enum TypeCommentType {
    ...
    public static TypeCommentType fromValue(String v) {
        for (TypeCommentType c: TypeCommentType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
