...
/**
 * Documents in what populations or samples an allele or genotype has been
 ...
 *       &lt;sequence>
 *         &lt;element name="Sample" type="{}typeSample"/>
 ...
 *                     &lt;/complexType>
 *                   &lt;/element>
 *                   &lt;element name="Severity" type="{}typeSeverity" minOccurs="0"/>
...
public class ObservationSet {
     ...
     *     
     */
    public void setSample(TypeSample value) {
        this.sample = value;
    }
    ...
    public static class ObservedData {
        ...
        protected TypeSeverity severity;
        @XmlElement(name = "Citation")
        protected List<TypeCitation> citation;
        @XmlElement(name = "XRef")
        protected List<TypeXref> xRef;
         ...
         *     
         */
        public TypeSeverity getSeverity() {
            return severity;
        }
         ...
         *     
         */
        public void setSeverity(TypeSeverity value) {
            this.severity = value;
        }
