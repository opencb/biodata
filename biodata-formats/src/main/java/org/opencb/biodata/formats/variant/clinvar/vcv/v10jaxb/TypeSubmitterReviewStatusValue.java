...
/**
 * <p>Java class for typeSubmitterReviewStatusValue.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="typeSubmitterReviewStatusValue">
 ...
 * 
 */
@XmlType(name = "typeSubmitterReviewStatusValue")
@XmlEnum
public enum TypeSubmitterReviewStatusValue {
    ...
    TypeSubmitterReviewStatusValue(String v) {
        value = v;
    }
    ...
    public static TypeSubmitterReviewStatusValue fromValue(String v) {
        for (TypeSubmitterReviewStatusValue c: TypeSubmitterReviewStatusValue.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
